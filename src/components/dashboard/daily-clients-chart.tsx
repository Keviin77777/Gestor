        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="space-y-2 flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <div className="p-2 rounded-lg bg-emerald-500/20 backdrop-blur-sm flex-shrink-0">
          ...
          <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                className="bg-emerald-50 dark:bg-slate-800/50 border-emerald-200 dark:border-slate-700 text-emerald-700 dark:text-slate-300 hover:bg-emerald-100 dark:hover:bg-slate-700/50 hover:text-emerald-900 dark:hover:text-white backdrop-blur-sm shadow-sm w-full sm:w-auto flex-shrink-0"
              >
